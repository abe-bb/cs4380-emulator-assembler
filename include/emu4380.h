...
enum Operations{JMP=1, JMR, BNZ, BGT, BLT, BRZ, MOV, MOVI, LDA, STR, LDR, STB, LDB, ISTR, ILDR, ISTB, ILDB, ADD, ADDI, SUB, SUBI, MUL, MULI, DIV, SDIV, DIVI, CMP=29, CMPI, TRP=31};
